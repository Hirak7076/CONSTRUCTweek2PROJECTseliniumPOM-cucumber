...
public class SportsShoes {
	...
	public static void capture(WebDriver driver, int n) throws IOException {
		...
		File imgFile = new File("C:\\Users\\User\\Desktop\\CWcucumberALLpagesSSs\\i\\" + n + ".png");
		FileUtils.copyFile(imagesFile, imgFile);
		
	}
	
	@Given("opening the browser then the URL and clicking the sports shoes option inside categories")
	public void opening_the_browser_then_the_url_and_clicking_the_sports_shoes_option_inside_categories() throws IOException {
		...
		WebElement SportsShoes = driver.findElement(By.xpath("(//a[@href='/shop-online/footwear-travel-bags/mens-footwear/sports-shoes.html'])[1]"));
		capture(driver, 1);
		act.moveToElement(categories).build().perform();
		act.moveToElement(FootwearANDBags).build().perform();
		act.moveToElement(SportsShoes).build().perform();
		SportsShoes.click();
		
	}

	@Given("testing all the header options of sports shoes")
	public void testing_all_the_header_options_of_sports_shoes() throws IOException {
	...
	@When("testing all the middle options of sports shoes")
	public void testing_all_the_middle_options_of_sports_shoes() throws IOException {
		driver.findElement(By.id("isexoutStock")).click();
		driver.findElement(By.xpath("(//a[@class=\"button_1\"])[1]")).click();
		
		String Parent = driver.getWindowHandle();
		
		driver.findElement(By.cssSelector("[title=\"Liberty Sports Shoes + Floaters + Multipurpose Bag\"]")).click();
		...
		driver.findElement(By.cssSelector("[title=\"Bacca Bucci Ankle Length Sports Shoes\"]")).click();
		wait.until(ExpectedConditions.numberOfWindowsToBe(2));
		...
		driver.findElement(By.cssSelector("[title=\"FW16 Complete Footwear Combo\"]")).click();
		wait.until(ExpectedConditions.numberOfWindowsToBe(2));
		...
		driver.findElement(By.cssSelector("[title=\"Aairwalk Complete Footwear Combo\"]")).click();
		wait.until(ExpectedConditions.numberOfWindowsToBe(2));
		...
		driver.findElement(By.cssSelector("[title=\"Bacca Bucci Set of 3 Sports Shoes + Flip Flops\"]")).click();
		wait.until(ExpectedConditions.numberOfWindowsToBe(2));
		...
		driver.findElement(By.cssSelector("[title=\"Bacca Bucci 3 Guna Jyada Shoes (Nano Tech Comfort Shoes)\"]")).click();
		wait.until(ExpectedConditions.numberOfWindowsToBe(2));
		...
		String Display5 = driver.findElement(By.xpath("(//span[@class=\"font-bold\"])[2]")).getText();
	...
	@When("testing all the leftbar options of sports shoes")
	public void testing_all_the_leftbar_options_of_sports_shoes() throws InterruptedException, IOException {
		...
		Thread.sleep(500);
		driver.findElement(By.id("brandFilterBox583")).click();
		Thread.sleep(500);
		driver.findElement(By.id("brandFilterBox38875")).click();
		Thread.sleep(500);
		driver.findElement(By.id("brandFilterBox8313")).click();
		Thread.sleep(500);
		driver.findElement(By.id("brandFilterBox38697")).click();
		Thread.sleep(500);
		driver.findElement(By.id("brandFilterBox4654")).click();
		Thread.sleep(500);
		driver.findElement(By.id("brandFilterBox38776")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("brandFilterBox37356")).click();
		...
		Thread.sleep(500);
		driver.findElement(By.id("featureFilterBox2f1")).click();
		Thread.sleep(500);
		driver.findElement(By.id("featureFilterBox0f1")).click();
		Thread.sleep(500);
		driver.findElement(By.id("featureFilterBox1f1")).click();
	...
	@When("testing all the footer options of sports shoes")
	public void testing_all_the_footer_options_of_sports_shoes() throws IOException {
		...
		driver.findElement(By.cssSelector("[name=\"header_search_text\"]")).sendKeys("Bacca Bucci 3 Guna Jyada Shoes (Nano Tech Comfort Shoes)");
		driver.findElement(By.xpath("(//div[@class=\"search\"])[2]")).click();
		capture(driver, 5);
		
	}

	@Then("closing the browser of sports shoes")
	public void closing_the_browser_of_sports_shoes() {
	    driver.close();
