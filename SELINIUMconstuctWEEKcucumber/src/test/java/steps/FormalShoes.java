...
public class FormalShoes {
	...
	public static void capture(WebDriver driver, int n) throws IOException {
		...
		File imgFile = new File("C:\\Users\\User\\Desktop\\CWcucumberALLpagesSSs\\e\\" + n + ".png");
		FileUtils.copyFile(imagesFile, imgFile);
		
	}
	
	@Given("opening the browser then the URL and clicking the formal shoes option inside categories")
	public void opening_the_browser_then_the_url_and_clicking_the_formal_shoes_option_inside_categories() throws IOException {
		...
		WebElement FormalShoes = driver.findElement(By.xpath("(//a[@href='/shop-online/footwear-travel-bags/mens-footwear/formal-shoes.html'])[1]"));
		
		act.moveToElement(categories).build().perform();
		act.moveToElement(FootwearANDBags).build().perform();;
		act.moveToElement(FormalShoes).build().perform();
		FormalShoes.click();
		capture(driver, 1);
		
	}

	@Given("testing all the header options of formal shoes")
	public void testing_all_the_header_options_of_formal_shoes() throws IOException {
	...
	@When("testing all the middle options of formal shoes")
	public void testing_all_the_middle_options_of_formal_shoes() throws IOException {
		driver.findElement(By.id("isexoutStock")).click();
		driver.findElement(By.xpath("(//a[@class=\"button_1\"])[1]")).click();
		
		String Parent = driver.getWindowHandle();
		
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[title='FW16 Formal Shoes + Casual Shoes']"))).click();
	...
	@When("testing all the leftbar options of formal shoes")
	public void testing_all_the_leftbar_options_of_formal_shoes() throws InterruptedException, IOException {
	...
	@When("testing all the footer options of formal shoes")
	public void testing_all_the_footer_options_of_formal_shoes() throws IOException {
	...
	@Then("closing the browser of formal shoes")
	public void closing_the_browser_of_formal_shoes() {
	    driver.close();
